...
import Sim from '@site/static/gif/sim.gif';
...
project's needs. You can find more information about recent underwater
simulators in our ICRA 2025 workshop [AQ²UASIM: Advancing Quantitative and
Qualitative Simulators for Marine Applications](https://sites.google.com/view/aq2uasim)

<img src={Sim} alt="Simulation demo gif" style={{ width: '100%', maxWidth: 700 }} />
