...
Blue provides a set of tools to help you test and deploy software for underwater
vehicles. This is accomplished through the following features:
...
<div className="vehicles">
   ...
   <Vehicle name="BlueROV2 Heavy Reach">
